...
const useStyles = makeStyles(theme => ({
  mainWrapper: {
    backgroundColor: theme.palette.bordabox, //DARK MODE PACK TYPEBOT//
    display: "flex",
  ...
  newMessageBox: {
    backgroundColor: theme.palette.newmessagebox, //DARK MODE PACK TYPEBOT//
    width: "100%",
    display: "flex",
    padding: "7px",
    alignItems: "center"
  ...
  messageInputWrapper: {
    padding: 6,
    marginRight: 7,
    backgroundColor: theme.palette.inputdigita, //DARK MODE PACK TYPEBOT//
    display: "flex",
    borderRadius: 20,
    flex: 1
  },
